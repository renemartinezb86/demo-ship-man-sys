package com.amazon.salaunch.demo.config;
...
@Configuration
@EnableMongoRepositories("com.amazon.salaunch.demo.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.amazon.salaunch.demo.config.dbmigrations");
