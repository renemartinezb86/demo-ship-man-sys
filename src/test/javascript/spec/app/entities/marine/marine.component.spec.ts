...
import { MarineComponent } from 'app/entities/marine/marine.component';
import { MarineService } from 'app/entities/marine/marine.service';
import { Marine } from 'app/shared/model/marine.model';

describe('Component Tests', () => {
  describe('Marine Management Component', () => {
    let comp: MarineComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(MarineComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.marines[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
