...
import { ShipLogComponent } from 'app/entities/ship-log/ship-log.component';
import { ShipLogService } from 'app/entities/ship-log/ship-log.service';
import { ShipLog } from 'app/shared/model/ship-log.model';

describe('Component Tests', () => {
  describe('ShipLog Management Component', () => {
    let comp: ShipLogComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ShipLogComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.shipLogs[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
